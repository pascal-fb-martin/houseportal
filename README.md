...
- [A control API](https://github.com/pascal-fb-martin/houseportal/blob/master/controlapi.md) is used to control physical devices, regardless of which protocol or interface is used to access these devices.
- A event API is used to access and aggregate events generated by each service.
